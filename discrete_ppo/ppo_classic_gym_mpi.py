...
parser.add_argument("--n-proc", type=int, default=6, help=" if running multi process data collection ")
...
if __name__ == "__main__":
    ...
    if args.n_proc > 1:
        envs = [create_env(args.env_name, i) for i in range(args.n_proc)]
        actors = [mlp_policy_net(state_size, 64, n_actions) for _ in range(args.n_proc)]
